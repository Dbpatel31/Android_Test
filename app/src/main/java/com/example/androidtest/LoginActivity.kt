    ...
    private fun postData() {
        ...
        retrodata.enqueue(object : Callback<List<OtpModel>> {
            override fun onResponse(
                ...
                Toast.makeText(applicationContext, "Response Successfully done", Toast.LENGTH_SHORT)
                    .show()
                Log.d("MainActivity","Response Successfully")
            }

            override fun onFailure(call: Call<List<OtpModel>>, t: Throwable) {
                Toast.makeText(applicationContext, "Response not getting", Toast.LENGTH_SHORT)
                    .show()
            }
